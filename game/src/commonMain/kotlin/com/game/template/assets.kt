...
class Assets(context: Context) : AssetPack(context) {
    ...
    val normalReiAnimations = ReiAnimations.Normal(context, runtimeTextureAtlasPacker, ::println).packed()
    val magicalReiAnimations = ReiAnimations.Magical(context, runtimeTextureAtlasPacker, ::println).packed()
...
sealed class ReiAnimations(context: Context, runtimeTextureAtlasPacker: RuntimeTextureAtlasPacker, mode: String, callback: (String) -> Unit) :
    ...
    val quickLeftPunch by "texture/rei/$mode/quick_left_punch".prepareAnimationPlayer(runtimeTextureAtlasPacker)
    val rightPunch by "texture/rei/$mode/right_punch".prepareAnimationPlayer(runtimeTextureAtlasPacker)
    val quickRightPunch by "texture/rei/$mode/quick_right_punch".prepareAnimationPlayer(runtimeTextureAtlasPacker)

    class Normal(context: Context, runtimeTextureAtlasPacker: RuntimeTextureAtlasPacker, callback: (String) -> Unit) :
        ReiAnimations(context, runtimeTextureAtlasPacker, "normal", callback)

    class Magical(context: Context, runtimeTextureAtlasPacker: RuntimeTextureAtlasPacker, callback: (String) -> Unit) :
