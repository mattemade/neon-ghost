...
class Wall(world: World, val x: Float, val y: Float, val shape: TiledMap.Object.Shape, mapHeight: Int) {
...
private fun TiledMap.Object.Shape.toPoints(): Array<Vec2> {
    return when (this) {
        ...
        is TiledMap.Object.Shape.Polygon -> TODO()
        is TiledMap.Object.Shape.Polyline -> TODO()
